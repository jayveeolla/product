...
<script>
import StatsCard from "@admin/Argon/components/Cards/StatsCard";
import RouteBreadCrumb from "@admin/Argon/components/Breadcrumb/RouteBreadcrumb";
import CalendarWidget from "./Widgets/CalendarWidget";
import TimelineCard from "./Widgets/TimelineCard";
import MembersCard from "@admin/Argon/views/Widgets/MembersCard";
import CreditCard from "@admin/Argon/views/Widgets/CreditCard";
import ProgressTrackList from "@admin/Argon/views/Widgets/ProgressTrackList";
import PaypalCard from "@admin/Argon/views/Widgets/PaypalCard";
import VectorMapCard from "@admin/Argon/views/Widgets/VectorMapCard";
import VisaCard from "@admin/Argon/views/Widgets/VisaCard";
import StatsCards from "@admin/Argon/views/Widgets/StatsCards";
import TaskList from "@admin/Argon/views/Widgets/TaskList";
