      ...
      <div class="content">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 d-inline-block mb-0">VIEW</h6>
            <nav
              aria-label="breadcrumb"
              class="d-none d-md-inline-block ml-md-4"
            ></nav>
          </div>
          <div class="col-lg-6 col-5 back-ss text-right" >
            <base-button
              style="width: 100.26px; height: 43.21px"
            class="heighbtn"
              tag="a"
              type="primary"
              :href="route('admin.product.edit', week.id)"
              aria-pressed="true"
            >
        ...
        <div class="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span class="v-html" v-html="week.product_ingredients"></span>
              </td>
            </tr>
...
@media only screen and (max-width: 600px) {
 ...
 .heighbtn{
     height: 60.21000000000001px !important;
